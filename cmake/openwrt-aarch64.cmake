...
# 抑制 OpenWrt 工具链 “STAGING_DIR not defined” 警告（须与 build-cross.sh 中 export 一致）
if(NOT DEFINED ENV{STAGING_DIR})
    set(ENV{STAGING_DIR} "${TOOLCHAIN_ROOT}")
endif()
# 确保 Ninja/Make 调用的编译器也带上该环境变量
set(CMAKE_TRY_COMPILE_PLATFORM_VARIABLES STAGING_DIR)
